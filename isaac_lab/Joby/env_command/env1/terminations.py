...
def below_min_altitude(env: ManagerBasedRLEnv, min_altitude: float) -> torch.Tensor: #para si baja a cierta altitud
    ...
    return asset.data.root_com_pos_w[:, 2] < min_altitude + 1.43 # Cambiar el 5.06 por la altura del centro de masas al final de las patas
